...
/*
 * Story 2 checks. These prove the lock behaves the way the story asks:
 ...
 *
 * The test supplies its own owner account through the two properties below, so
 * it does not depend on the real environment variables. The hash is a real
 * BCrypt hash of the password "testpass123".
 */
...
class SecurityConfigTest {
     ...
     * in for the deploy script polling /health on the server. It should reach
     * the real /health endpoint and return 200.
     */
    @Test
     ...
     * Either way, the outside caller never sees the health response.
     */
    @Test
